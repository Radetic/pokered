...
ELIF DEF(_GLAU)
	...
	db 5, PIKACHU, 0
; Route 22
	db 5, PIDGEY, TANGELA, BULBASAUR, CHARMANDER, SQUIRTLE, SNORLAX, 0
	db 5, TENTACOOL, SPEAROW, KOFFING, GRIMER, RATTATA, DRATINI, 0
	db 5, POLIWAG, SPEAROW, GOLDEEN, MAGMAR, TANGELA, PIKACHU, 0
; Cerulean City
