...
ELIF DEF(_RADZ)
	db $FF, 7, WEEDLE, 7, KAKUNA, 7, WEEDLE, 8, SQUIRTLE, 8, BULBASAUR, 8, CHARMANDER, 0
ELSE
...
; Route 21
	...
	db 8, TENTACOOL, TENTACOOL, TENTACOOL, 0
...
IF DEF(_RADZ)
	...
	db 5, R_STARTER3, 0
; Route 22
	db $FF, 5, TANGELA, 5, BULBASAUR, 5, CHARMANDER, 5, SQUIRTLE, 5, TENTACOOL, 8, R_STARTER1, 0
	db $FF, 2, POLIWAG, 3, STARYU, 3, HORSEA, 3, SHELLDER, 3, GOLDEEN, 8, R_STARTER2, 0
	db $FF, 4, RATTATA, 4, NIDORAN_F, 4, NIDORAN_M, 5, SPEAROW, 5, PIDGEY, 8, R_STARTER3, 0
; Cerulean City
...
; Cerulean City
	db $FF, 12, BEEDRILL, 15, PIDGEOTTO, 18, SPEAROW, 15, ODDISH, 15, POLIWAG, 17, SNORLAX, 0
	db $FF, 12, CLEFAIRY, 15, BELLSPROUT, 18, GEODUDE, 15, GOLDEEN, 15, GROWLITHE, 17, DRATINI, 0
	db $FF, 12, BUTTERFREE, 15, SQUIRTLE, 18, PIDGEOTTO, 15, CHARMANDER, 15, BULBASAUR, 17, PIKACHU, 0
ELSE
	db 5, R_STARTER1, 0
	db 5, R_STARTER2, 0
	db 5, R_STARTER3, 0
...
ELIF DEF(_RADZ)
	db $FF, 9, PIDGEY, 9, WEEDLE, 11, DIGLETT, 11, SANDSHREW, 12, GEODUDE, 14, ONIX, 0
ELSE
