...
; Route 20
	...
	db 9, STARYU, 0
	db 8, HORSEA, HORSEA, HORSEA, HORSEA, 0
; Route 21
	db 7, HORSEA, TENTACOOL, 0
	db 7, STARMIE, 0
	db 7, STARYU, SQUIRTLE, 0
	db 6, POLIWAG, TENTACOOL, HORSEA, 0
...
; Route 21
	db 6, TENTACOOL, TENTACOOL, TENTACOOL, 0
...
; Route 20
	db 9, GOLDEEN, 0
	db 8, SHELLDER, SHELLDER, CLOYSTER, 0
	db 8, POLIWAG, GOLDEEN, 0
; Route 15
