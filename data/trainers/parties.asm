...
ELIF DEF(_GLAU)
	...
	db 5, PIKACHU, 0
; Route 22
	db $FF, 5, PIDGEY, 5, TANGELA, 5, BULBASAUR, 5, CHARMANDER, 5, SQUIRTLE, 5, SNORLAX, 0
	db $FF, 5, TENTACOOL, 5, SPEAROW, 5, KOFFING, 5, GRIMER, 5, RATTATA, 5, DRATINI, 0
	db $FF, 5, POLIWAG, 5, SPEAROW, 5, GOLDEEN, 5, MAGMAR, 5, TANGELA, 5, PIKACHU, 0
; Cerulean City
