...
; Route 3
IF DEF(_GLAU)
	db $FF, 2, POLIWAG, 3, STARYU, 3, HORSEA, 3, SHELLDER, 3, GOLDEEN, 4, RATTATA, 0
ELIF DEF(_RADZ)
	db 4, RATTATA, PIDGEY, 0
ELSE
...
; Pewter Gym
IF DEF(_GLAU)
	db $FF, 3, GROWLITHE, 3, VULPIX, 4, PONYTA, 4, MAGMAR, 5, KOFFING, 5, GRIMER, 0
ELIF DEF(_RADZ)
	db 4, RATTATA, NIDORAN_F, NIDORAN_M, CATERPIE, WEEDLE, METAPOD, 0
ELSE
...
; Route 21
IF DEF(_RADZ)
	db 6, GOLDEEN, GOLDEEN, GOLDEEN, GOLDEEN, 0
	db 7, SHELLDER, CLOYSTER, 0
	db 6, MAGIKARP, MAGIKARP, MAGIKARP, MAGIKARP, MAGIKARP, MAGIKARP, 0
...
; Route 21
IF DEF(_RADZ)
	db 8, HORSEA, TENTACOOL, 0
	db 9, STARMIE, 0
	db 8, STARYU, SQUIRTLE, 0
...
IF DEF(_RADZ)
	...
	db 5, R_STARTER3, 0
; Route 22
	db $FF, 5, TANGELA, 2, MAGIKARP, 3, POLIWAG, 5, TENTACOOL, 9, RATTATA, 8, R_STARTER1, 0
	db $FF, 3, STARYU, 3, HORSEA, 3, SHELLDER, 3, GOLDEEN, 9, PIDGEY, 8, R_STARTER2, 0
	db $FF, 4, RATTATA, 4, NIDORAN_F, 4, NIDORAN_M, 5, SPEAROW, 9, PIDGEY, 8, R_STARTER3, 0
; Cerulean City
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, R_STARTER1, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, R_STARTER2, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, R_STARTER3, 0
ELIF DEF(_LNKN)
	db 5, R_STARTER1, 0
	db 5, R_STARTER2, 0
	db 5, R_STARTER3, 0
; Route 22
	db $FF, 9, PIDGEY, 8, R_STARTER1, 0
	db $FF, 9, PIDGEY, 8, R_STARTER2, 0
	db $FF, 9, PIDGEY, 8, R_STARTER3, 0
; Cerulean City
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, R_STARTER1, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, R_STARTER2, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, R_STARTER3, 0
ELIF DEF(_GLAU)
	...
	db 5, R_STARTER3, 0
; Route 22
	db 5, PIDGEY, TANGELA, BULBASAUR, CHARMANDER, SQUIRTLE, R_STARTER1, 0
	db 5, TENTACOOL, SPEAROW, KOFFING, GRIMER, RATTATA, R_STARTER2, 0
	db 5, POLIWAG, SPEAROW, GOLDEEN, MAGMAR, TANGELA, R_STARTER3, 0
; Cerulean City
	db $FF, 12, BEEDRILL, 15, PIDGEOTTO, 18, SPEAROW, 15, ODDISH, 15, POLIWAG, 17, R_STARTER1, 0
	db $FF, 12, CLEFAIRY, 15, BELLSPROUT, 18, GEODUDE, 15, GOLDEEN, 15, GROWLITHE, 17, R_STARTER2, 0
	db $FF, 12, BUTTERFREE, 15, SQUIRTLE, 18, PIDGEOTTO, 15, CHARMANDER, 15, BULBASAUR, 17, R_STARTER3, 0
ELSE
	db 5, R_STARTER1, 0
	db 5, R_STARTER2, 0
	db 5, R_STARTER3, 0
...
BrockData:
IF DEF(_GLAU)
	db $FF, 9, WEEDLE, 9, STARMIE, 11, DIGLETT, 11, SANDSHREW, 12, GEODUDE, 14, ONIX, 0
ELIF DEF(_RADZ)
	db $FF, 5, PIDGEY, 5, SPEAROW, 7, DIGLETT, 7, SANDSHREW, 8, GEODUDE, 9, ONIX, 0
ELSE
