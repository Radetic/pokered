...
; Route 10
	...
	db 6, PIKACHU, CLEFAIRY, 0
	; db 21, PIDGEY, PIDGEOTTO, 0
	db 7, PIDGEY, PIDGEY, 0
; Rock Tunnel B1F
	; db 21, JIGGLYPUFF, PIDGEY, MEOWTH, 0
	db 6, JIGGLYPUFF, PIDGEY, MEOWTH, 0
	; db 22, ODDISH, BULBASAUR, 0
	db 7, ODDISH, BULBASAUR, 0
; Celadon Gym
...
; Rock Tunnel B1F
	...
	db 6, GEODUDE, GEODUDE, GEODUDE, 0
	; db 25, GEODUDE, 0
	db 8, GEODUDE, 0
...
; Fighting Dojo
	...
	db 6, MANKEY, MANKEY, MANKEY, 0
	; db 32, MACHOP, MACHOKE, 0
	db 6, MACHOP, MACHOP, 0
	; db 36, PRIMEAPE, 0
	db 8, MANKEY, 0
	; db 31, MACHOP, MANKEY, PRIMEAPE, 0
	db 6, MACHOP, MANKEY, MANKEY, 0
; Viridian Gym
