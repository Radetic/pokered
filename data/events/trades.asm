...
IF DEF(_RADZ)
	...
	db MAGMAR,     CHARMANDER,TRADE_DIALOGSET_CASUAL, "HITOKAGE@@@"
	...
	db PIKACHU,    BULBASAUR, TRADE_DIALOGSET_POLITE, "FUSHIGIDANE"
	db GOLDEEN,    SQUIRTLE,  TRADE_DIALOGSET_HAPPY,  "ZENIGAME@@@"
